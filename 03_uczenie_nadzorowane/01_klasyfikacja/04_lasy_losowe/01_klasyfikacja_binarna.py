...
# %% 
evaluate_binary_classification(random_forest_clf, X_train, X_test, y_train, y_test)

# %%
# sudo apt install python-pydot python-pydot-ng graphviz
clf_3 = random_forest_clf.estimators_[3]
print(clf_3)
...
gs = GridSearchCV(random_forest_clf , param_grid=param_grid, scoring='accuracy', n_jobs=-1)
